...
export default function Home() {
    return (
        <>
            <Header />
            <section className="lg:px-[100px] px-[40px] bg-[#FFF] lg:pt-[200px] pt-[100px] overflow-hidden pb-[40px]">
                <div className="col-lg-12 text-center lg:pt-[80px] pt-[40px] mb-4">
                    <p className="lg:text-[1.9vw] lg:leading-[2vw] p-0 mb-2 text-[4vw] font-bold text-[#1B1B1B]">Amazon Seller Account Handling Services</p>
                    <p className="lg:text-[1vw] lg:leading-[1vw] p-0 m-0 text-[3vw]  text-[#666666]">Expand Your Amazon Business with Professional Assistance</p>
                </div>
                <div className="col-lg-12 lg:pt-[80px] pt-[20px] mb-4">
                    <div className="lg:flex gap-4 items-center">
                        ...
                        <div className="col-lg-6 ">
                            <div className="col-lg-6">
                                <p className="lg:text-[1vw] text-[5vw] font-bold text-[#090909]">Start Selling on Amazon</p>
                 ...
                 <div className="lg:flex mb-4 ">
                    <div className="col-lg-6 ">
                        ...
                        <div className="col-lg-9 ">
                            ...
                            <div className="">
                        <p className="lg:text-[1vw] text-[3vw] text-[#0B3655] font-semibold p-0 m-0">Amazon Account Creation & Enhancement</p>
                        ...
                        <ul className="mt-2 list-disc text-[#666666] lg:text-[0.8vw] lg:leading-[1vw] font-medium text-[3vw]">
                        ...
                        <div className=" lg:mt-[40px] mt-[20px]">
                            ...
                            <div className="">
                        <p className="lg:text-[1vw] text-[3vw] text-[#0B3655] font-semibold p-0 m-0">Amazon PPC Campaign Management</p>
                        <p className="lg:text-[0.8vw] lg:leading-[1vw] font-medium text-[3vw] text-[#666666] mt-2">Boost your product visibility with targeted Amazon PPC campaigns. We manage your advertising efforts to maximize return on investment (ROI), using proven strategies to reach more customers while keeping ad costs efficient..</p>
                        <ul className="mt-2 list-disc text-[#666666] lg:text-[0.8vw] lg:leading-[1vw] font-medium text-[3vw]">
                        ...
                        <div className=" lg:mt-[40px] mt-[20px]">
                            ...
                            <div className="">
                        <p className="lg:text-[1vw] text-[3vw] text-[#0B3655] font-semibold p-0 m-0">Account Performance Tracking</p>
                        ...
                        <ul className="list-disc mt-4  lg:text-[0.8vw] lg:leading-[1.2vw] font-medium text-[3vw]">
                            <li className="">
                           <span className="text-[#000]  lg:text-[0.8vw] lg:leading-[1vw] font-bold text-[3vw]">Global Amazon Market Expertise:</span> Global Amazon Market Expertise: Whether you&apos;re selling locally or internationally, our team has the experience to expand your business across Amazon&apos;s global marketplaces.
                            </li>
                        </ul>
                        <ul className="list-disc mt-4  lg:text-[0.8vw] lg:leading-[1.2vw] font-medium text-[3vw]">
                            <li className="">
                           <span className="text-[#000]  lg:text-[0.8vw] lg:leading-[1vw] font-bold text-[3vw]"> Analytics-Driven Strategy:</span> We leverage data and insights to make informed decisions, ensuring continuous improvement for your business.
                            </li>
                        </ul>
                        <ul className="list-disc mt-4  lg:text-[0.8vw] lg:leading-[1.2vw] font-medium text-[3vw]">
                            <li className="">
                           <span className="text-[#000]  lg:text-[0.8vw] lg:leading-[1vw] font-bold text-[3vw]">Continuous Assistance: </span>We don&apos;t just set you up and walk away—our team offers ongoing support to ensure your business operates seamlessly.
                            </li>
                        </ul>
                        </div>
                        </div>
                    ...
                    <div className="col-lg-6 ">
                        ...
                        <div className="col-lg-9 ">
                            ...
                            <div className="">
                        <p className="lg:text-[1vw] text-[3vw] text-[#0B3655] font-semibold p-0 m-0">Product Listing Enhancement</p>
                        ...
                        <div className=" lg:mt-[40px] mt-[20px]">
                            ...
                            <div className="">
                        <p className="lg:text-[1vw] text-[3vw] text-[#0B3655] font-semibold p-0 m-0">Inventory and Order Tracking Management</p>
                        <p className="lg:text-[0.8vw] lg:leading-[1vw] font-medium text-[3vw] text-[#666666] mt-2">Efficient inventory management prevents stockouts or excess inventory on Amazon. We assist with demand forecasting, supply chain management, and seamless integration with Amazon’s fulfillment system.</p>
                        <ul className="mt-2 list-disc text-[#666666] lg:text-[0.8vw] lg:leading-[1vw] font-medium text-[3vw]">
                        ...
                        <div className=" lg:mt-[40px] mt-[20px]">
                            ...
                            <div className="">
                        <p className="lg:text-[1vw] text-[3vw] text-[#0B3655] font-semibold p-0 m-0">Amazon FBA and Shipping Optimization Solutions</p>
                        <p className="lg:text-[0.8vw] lg:leading-[1vw] font-medium text-[3vw] text-[#666666] mt-2">Fulfillment by Amazon (FBA) offers great advantages, but it requires careful planning. We assist with setting up FBA, optimizing your shipping processes, and ensuring timely deliveries to improve customer satisfaction.</p>
                        <ul className="mt-2 list-disc text-[#666666] lg:text-[0.8vw] lg:leading-[1vw] font-medium text-[3vw]">
