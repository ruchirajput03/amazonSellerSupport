                    ...
                    <div className="row justify-between sm:pb-[30px]">
                        <div className="col-md-3">
                            ...
                            <div className="pt-[20px]">
                                <p className="Syne-Regular text-[#E6E6E6] sm:text-[14px] text-[14px]  mb-2">Amazon Seller Support is a full-service global agency specializing in Amazon, eBay, and Noon, where sustainable growth and profitability are our top priorities for our partners. Our services include, but are not limited to: Account Management, Brand Protection, Logistics and Operations, Advertising, DSP, and tailored solutions designed to maximize your success on these platforms.</p>
                            </div>
                        </div>
                            ...
                            <div className="row relative">
                                <div className="col-md-3">
                                    <div className="sm:pt-[0px] pt-[20px]">
                                        <p className=" font-bold text-[#FFF] sm:text-[18px] text-[15px]  mb-2">Company</p>
                                        <div>
                                            <Link href="/contactus" className="!no-underline">
                                                <span className="
                                                 text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2">
                                                    Contact Us
                                            ...
                                            <Link href="/FooterPages/Amazon3" className="!no-underline">
                                                <span className=" text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2">Our team</span>
                                            </Link>
                                            <Link href="/FooterPages/Amazon4" className="!no-underline">
                                                <span className=" text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2"> Careers</span>
                                            </Link>
                                            <Link href="/FooterPages/Amazon5" className="!no-underline">
                                                <span className=" text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2"> Privacy Policy</span>
                                            </Link>
                                ...
                                <div className="col-md-3">
                                    <div className="sm:pt-[0px] pt-[20px]">
                                        <p className="Syne-Regular text-[#FFFF] sm:text-[18px] text-[15px]  mb-2">Our Services
                                        ...
                                        <div>
                                            <Link href="/amazonConsultancy" className="!no-underline">
                                                <span className="Syne-Regular text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2">Amazon Consultancy</span>
                                            </Link>
                                            <Link href="/noonConsultancy" className="!no-underline">
                                                <span className="Syne-Regular text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2">Noon Consultancy</span>
                                            </Link>
                                            <Link href="/design&Dev" className="!no-underline">
                                                <span className="Syne-Regular text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2">Design & Development</span>
                                            </Link>
                                            <Link href="/taxfiling" className="!no-underline">
                                                <span className="Syne-Regular text-[#E6E6E6] sm:text-[14px] text-[14px] block  mb-2">
                                ...
                                <div className="col-lg-6 flex justify-end">
                                    <div className="sm:pt-[0px] pt-[20px]">
                                        <p className=" font-bold text-[#FFF] sm:text-[18px] text-[15px]  mb-4">Subscribe to our newsletter*</p>
