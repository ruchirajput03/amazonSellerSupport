      ...
      <section className="lg:px-[100px] px-[20px] z-100 fixed w-full bg-[#000124] lg:py-3">
        <div className="flex justify-items-center justify-center ">
          <div className="container-fluid w-full col-lg-12 z-100 flex items-center !justify-center py-4 lg:h-30 lg:pt-[40px]">
            ...
            <div className="col-lg-8 w-full lg:bg-[#151A29D9] lg:py-4  lg:px-5 text-center items-center rounded-full ">
              ...
              <nav className="mx-auto  hidden lg:flex items-center justify-between lg:text-[1vw] text-[2vw] lg:leading-[1vw] text-white leading-[3vw] font-medium">
                ...
                >
                  <button className="flex items-center text-lg   group ">
                    Services
                    <span className="ml-1 text-sm icon icon-tabler icons-tabler-filled icon-tabler-caret-down transform transition-transform duration-300 group-hover:rotate-0 rotate-180">
                  ...
                  {openMenu === "products" && (
                    <div className="absolute top-[15px] py-3  w-[250px] bg-white shadow-sm rounded-md">
              ...
              <div className="flex  justify-between lg:hidden ">
                <Image src='/assets/logo.svg' className="sm:w-[180px] w-[120px] flex jutsify-start" width={1080} height={1080} alt="amazonsellersupport.ae" />
                <button
